    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
               ...
               <input type="text" name="alamat" placeholder="Alamat" class="input-control" value="<?php echo $d->admin_adress?>" require>
            ...
            <div class="box">
               ...
               <input type="password" name="pass2" placeholder="Konfirmasi Password" class="input-control" require>
